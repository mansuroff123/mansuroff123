...
I am a Software Engineering student and Full-Stack Developer deeply passionate about building scalable, high-performance web applications and exploring the mysteries of the cosmos. 🚀

- 💻 **Current Focus:** Developing production-ready apps with **AstroJS** and **SolidJS**.
- 🛠 **Backend Craft:** Building lightweight, secure APIs using **Express.js**, **Node.js**, and modern ORMs.
- 🌌 **Interests:** Astronomy, space exploration missions, and building neat full-stack tools.
- ⚡ **Fun Fact:** My coding environment is powered by TypeScript and driven by residual heat — like a perfect Italian Carbonara. 🍝
